from src.vision.matching.domain.services.MatchInterestPointsWithBRIEF import MatchInterestPointsWithBRIEF
from src.vision.matching.domain.services.MatchInterestPointsWithBrisk import MatchInterestPointsWithBrisk
from src.vision.matching.domain.services.MatchInterestPointsWithOrb import MatchInterestPointsWithOrb
from src.vision.matching.domain.services.MatchInterestPointsWithSurf import MatchInterestPointsWithSurf
from src.vision.matching.domain.services.MatchInterestPointsWithSift import MatchInterestPointsWithSift
from src.vision.matching.domain.services.MatchInterestPointsWithFREAK import MatchInterestPointsWithFREAK
